  ...
  <body>
    <div id="wrapper">
      ...
      <div class="sidebar">
        ...
        <p class="brand-title"><a href="">Kings Blog</a></p>

        <div class="side-links">
          <ul>
            <li><a class="{{ Request::routeIs('welcome.index') ? 'active':'' }}" href="{{ asset('/') }}">Home</a></li>
        ...
        <footer class="sidebar-footer">
          ...
          <small>&copy 2022 Kings Blog</small>
        </footer>
      </div>
      <!-- Menu Button -->
